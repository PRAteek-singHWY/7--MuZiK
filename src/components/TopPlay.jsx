...
const TopPlay = () => {
  ...
  return (
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 xl:max-w-[461px] max-w-full flex flex-col">
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="flex flex-row justify-between items-center" >
          ...
          <Link to="/top-charts" >
            <p className="text-gray-300 text-base cursor-pointer hover:text-yellow-400 mt-5">see more</p>
          </Link>
        </div>
      ...
      {/* Top ARtist and see more */}
      <div className="flex flex-col tp-6">
        ...
        {/* swiper kind of div to see the top artists and and their images */}
        <Swiper
          slidesPerView="auto"
          spaceBetween={15}
          freeMode
        ...
        >
          {topPlays?.map((topSong, i) => (
            <SwiperSlide
              ...
              <Link to={`/artists/${topSong?.artists[0].adamid}`}>
                <img src={topSong?.images.background} alt="name"
